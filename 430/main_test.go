...
func TestLFU(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Example 1",
			cmds: []string{"LFUCache", "put", "put", "get", "put", "get", "get", "put", "get", "get", "get"},
			args: [][]int{[]int{2}, []int{1, 1}, []int{2, 2}, []int{1}, []int{3, 3}, []int{2}, []int{3}, []int{4, 4}, []int{1}, []int{3}, []int{4}},
			res:  []int{0, 0, 0, 1, 0, -1, 3, 0, -1, 3, 4},
		},
		//{
		//	name: "Example 24",
